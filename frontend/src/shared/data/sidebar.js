...
const translations = {
  en: {
    ...
    salesReport: "Sales", inventoryReport: "Inventory",
  ...
  ur: {
    ...
    salesReport: "سیلز", inventoryReport: "انوینٹری",
  ...
  ur_en: {
    ...
    salesReport: "سیلز / Sales", inventoryReport: "انوینٹری / Inventory",
...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    allowedUrls: ["/reports/main-business", "/reports/sales",
