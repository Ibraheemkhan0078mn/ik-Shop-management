...
import logoImage from "../assets/images/ssiLogo.png";
import { printElementAsPdf } from '../services/elementAsPdf';
...
const TransactionReceipt = ({ data, setVisibility }) => {
    ...
    const handlePrint = () => {
        printElementAsPdf({ ref: componentRef, title: `Receipt_${data?.receiptNo || '001'}` })
    }
