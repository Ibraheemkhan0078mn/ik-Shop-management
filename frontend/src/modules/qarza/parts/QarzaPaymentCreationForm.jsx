...
export default function QarzaPaymentCreationForm({ getAccountPaymentAndSummary, setQarzaPaymentData, setVisibility, qarzaAccountId }) {
    ...
    useEffect(() => {
        setFormData({ ...formData, qarzaAccountId: qarzaAccountId })
    }, [qarzaAccountId])
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-3xl font-black text-slate-800 tracking-tighter">
                                Create <span className="text-cyan-500">Qarza</span>
                            </h1>
                        </div>
                        <p className="text-sm font-semibold text-slate-400 mt-2 ml-1 flex items-center gap-2">
                            <i className="ri-exchange-box-line text-cyan-400"></i>
                            Recording a new credit/debit transaction
                        </p>
                    </div>
                </div>
                ...
                <form className="p-8 space-y-6 bg-slate-50/30" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-cyan-600 uppercase tracking-widest ml-1">Transaction Amount</label>
                        ...
                        {/* Date Input */}
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-cyan-600 uppercase tracking-widest ml-1">Entry Date</label>
                            <input
                                type="date"
                                name="date"
                                value={formData.date}
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            placeholder="Enter payment notes or description..."
                        />
                    </div>
