...
const InvesterPaymentUpdate = ({ setVisible, memberId, paymentData, getInvesterPayments }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await api.put(`/memberRoute/updateSalaryPayment`, {
                ...formData,
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-3xl font-black text-ink tracking-tighter">
                                Update <span className="text-ink">Invester Payment</span>
                            </h1>
                        </div>
