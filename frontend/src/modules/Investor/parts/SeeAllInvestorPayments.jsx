...
export default function SeeAllTeacherPayments({ teacherId, setVisibility, setTeacherSalaryPaymentCreationFormVisible }) {
    ...
    useEffect(() => {
        async function load() {
            try {
                const res = await api.post(`/memberRoutes/getTeacherSalaryPayments`, { teacherId: teacherId });
    ...
    async function handleDelete(paymentId) {
        try {
            const res = await api.delete(`/memberRoutes/deleteSalaryPayment`, { data: { teacherId: teacherId, salaryId: paymentId } });
            if (res.data.success) {
