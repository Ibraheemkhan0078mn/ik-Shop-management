...
const InvestorPaymentCreate = ({ setVisible, teacherId, getInvesterPayments }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await api.post(`/memberRoutes/createTeacherSalaryPayment`, { ...formData, teacherId: teacherId })
            if (res.data.success) {
                getInvesterPayments()
                setVisible(false);
            }
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-3xl font-black text-slate-800 tracking-tighter">
                                Add <span className="text-cyan-500">Invester Payment</span>
                            </h1>
                        </div>
