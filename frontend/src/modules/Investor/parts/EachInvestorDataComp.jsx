...
import TeacherUpdate from './InvestorUpdate.jsx';
import { Edit, Trash2 } from 'lucide-react';
import TeacherDocumentsComp from './InvestorDocuemntsComp.jsx';
            ...
            <div className="relative w-full max-w-[80%] h-[85vh] bg-white rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row overflow-hidden animate-in zoom-in-95 duration-500">
                ...
                <div className="w-full relative md:w-80 bg-linear-to-b from-cyan-600 to-cyan-800 p-8 flex flex-col text-white">
                    ...
                    <div className="mb-10">
                        <div className="  rounded-2xl overflow-hidden flex items-center justify-center mb-6 ">
                            <img
                                ...
                                src={(`${backendBaseUrl}/uploads/${teacherData?.profileImage}` && teacherData?.profileImage) ? `http:///uploads/${teacherData.profileImage}` : boy_empty_user} alt="" />
                        </div>
                    ...
                    <PermissionGuard permission={"teacher-delete"}>
                        <ConfirmDialog onConfirm={() => { handleTeacherDeleteIconClick() }} message='Are you want to delete the invester' >
                ...
                <div className="flex-1 bg-slate-50 flex flex-col relative overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-10 custom-scrollbar">
                     ...
                     flex items-center gap-2"
                        ...
                        <PermissionGuard permission={"investor-financial-view"}>
                            {
                                activeTab === 'salary' && <InvestorFinancialHub teacherId={teacherId} teacherData={teacherData} />
                            }
                        </PermissionGuard>
                    ...
                    {/* <div className="px-10 py-6 bg-white border-t border-slate-100 flex justify-between items-center">
                        ...
                        <button
                            onClick={async () => {
                                const res = await api.post("/memberRoutes/teacherDelete", { teacherDocId: teacherId });
