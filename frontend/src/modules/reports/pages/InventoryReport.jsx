    ...
    return (
        <div className="p-6 min-h-screen bg-[var(--app-bg)]">
            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
                <div>
                    <h1 className="text-2xl font-bold text-[var(--ink)] font-display">Inventory Report</h1>
            ...
            <div className="card p-4 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                    ...
                    <div>
                        <label className="text-xs font-medium text-[var(--muted)] mb-1 block">Category</label>
                        <select
                            value={categoryId}
                    ...
                    <div>
                        <label className="text-xs font-medium text-[var(--muted)] mb-1 block">Product Name</label>
                    ...
                    <div>
                        <label className="text-xs font-medium text-[var(--muted)] mb-1 block">Product Code</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="text-xs font-medium text-[var(--muted)] mb-1 block">Tag</label>
                        <select
                            value={tag}
