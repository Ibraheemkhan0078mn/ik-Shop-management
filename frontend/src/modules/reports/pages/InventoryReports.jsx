...
const App = () => {
    ...
    // Inventory Summary Stats Data
    const stats = [
        {
            title: language === "en" ? "Total Items" : "کل اشیاء",
            value: "2,840",
        },
        {
            title: language === "en" ? "Low Stock" : "کم اسٹاک",
            value: "18",
        },
        {
            title: language === "en" ? "Stock Value" : "اسٹاک کی مالیت",
            value: "$342,000",
        },
        {
            title: language === "en" ? "Wastage (MTD)" : "ضیاع (مہینہ)",
            value: "$840",
        },
    ];
