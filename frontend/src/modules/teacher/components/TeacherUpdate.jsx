...
const TeacherUpdate = ({ teacherId, setVisibility, setData }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        address: '', post: 'teacher', education: '',
        isSalary: "",
        salary: "",
    ...
    useEffect(() => {
        if (teacherData) {
            setFormData({
                ...
                isPartner: teacherData.isPartner || false,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // const response = await api.post(`/teacherRoute/teacherUpdate`, data, {
