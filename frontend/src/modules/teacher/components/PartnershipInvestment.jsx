...
const PartnershipInvestment = ({ teacherId, teacherData }) => {
    ...
    return (
        <div className="animate-in slide-in-from-bottom-4 duration-500 space-y-4 max-w-5xl mx-auto">
            ...
            {investmentCreationVisibility && <PartnerInvestmentCreation setVisibility={setInvestmentCreationVisibility} />}
                        ...
                        <div className="relative flex items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3 min-w-[140px]">
                                ...
                                <div>
                                    ...
                                    <h5 className="text-xs font-bold text-slate-800">Funding Injection</h5>
                                </div>
                            </div>
