...
export default function SupplierTransactionsPdfTemplate({ supplier = {}, transactions = [], summary = {}, source = "all", entityLabel = "Supplier" }) {
    ...
    return (
        <div className="min-h-screen p-10" style={{ fontFamily: "Arial, sans-serif", color: "#1f2937", backgroundColor: "#ffffff", fontSize: "13px", lineHeight: 1.4 }}>
            <div className="mb-6 border-b-2 border-gray-300 pb-4 text-center">
                <div className="mb-2 inline-flex flex-col items-center leading-none">
                    <span className="text-3xl font-extrabold tracking-wide" style={{ color: "#111827", letterSpacing: "2px" }}>LOGIN</span>
                    <span className="mt-1 text-xs font-semibold tracking-[0.3em]" style={{ color: "#6b7280" }}>LARAIB</span>
                </div>
                <h1 className="mt-2 text-2xl font-bold" style={{ color: "#111827" }}>{entityLabel} Credits &amp; Debits</h1>
                <p className="mt-1 text-sm" style={{ color: "#6b7280" }}>{sourceLabel}</p>
            </div>

            <div className="mb-6 grid grid-cols-2 gap-6">
                <div className="rounded-lg border p-4" style={{ borderColor: "#d1d5db", backgroundColor: "#f9fafb" }}>
                    <p className="mb-3 text-xs font-bold uppercase tracking-wide" style={{ color: "#6b7280" }}>{entityLabel} Information</p>
                ...
                <div className="rounded-lg border p-4" style={{ borderColor: "#d1d5db", backgroundColor: "#f9fafb" }}>
                    <p className="mb-3 text-xs font-bold uppercase tracking-wide" style={{ color: "#6b7280" }}>Account Summary</p>
                    <div className="space-y-2 text-sm">
