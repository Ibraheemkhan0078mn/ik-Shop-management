...
export const memberApi = baseApi.injectEndpoints({
    endpoints: (build) => ({
        ...
        getAllMembers: build.query({
            query: () => ({ url: "/api/memberRoute/getAllMembersData", method: "GET" }),
            transformResponse: (res) => res?.allMemberData ?? [],
            providesTags: ["Member"],
        }),

        getMemberById: build.query({
            query: (memberId) => ({ url: "/api/memberRoute/getMemberDataOnId", method: "POST", body: { memberId } }),
            transformResponse: (res) => res?.memberdata ?? null,
            providesTags: (result, error, id) => [{ type: "Member", id }],
        }),

        createMember: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/memberCreation", method: "POST", body }),
            invalidatesTags: ["Member"],
        }),

        updateMember: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/memberUpdate", method: "POST", body }),
        ...
        deleteMember: build.mutation({
            query: (memberDocId) => ({ url: "/api/memberRoute/memberDelete", method: "POST", body: { memberDocId } }),
            invalidatesTags: ["Member"],
        }),
        ...
        getMemberAttendance: build.query({
            query: (memberId) => {
                ...
                return { url: "/api/memberRoute/fromTillTimeAttendenceCalculation", method: "POST", body: { memberDocId: memberId, fromDate: from, tillDate: till } };
            },
            providesTags: (result, error, id) => [{ type: "MemberAttendance", id }],
        }),

        getAttendanceByDate: build.query({
            query: (body) => ({ url: "/api/memberRoute/getSelectedDayMembersAttendenceData", method: "POST", body }),
            providesTags: (result, error, arg) => [{ type: "MemberAttendance", id: arg?.date }],
        }),

        markScannerAttendance: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/setAttendanceByInstituteIdScanning", method: "POST", body }),
            invalidatesTags: (result, error, arg) => [{ type: "MemberAttendance", id: arg?.date }],
        }),

        createDayAttendance: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/createdSeletedDayMemberAttendence", method: "POST", body }),
            invalidatesTags: (result, error, arg) => [{ type: "MemberAttendance", id: arg?.date }],
        }),

        updateMemberAttendanceStatus: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/setMemberAttendence", method: "POST", body }),
        ...
        uploadMemberDocument: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/uploadMemberDocuments", method: "POST", body, formData: true }),
            invalidatesTags: (result, error, body) => [{ type: "Member", id: body.get?.("memberDocId") }],
        }),

        deleteMemberDocument: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/deleteMemberDocument", method: "POST", body }),
        ...
        getMemberFinance: build.query({
            query: (id) => ({ url: "/api/memberRoute/getMemberFinanceData", method: "POST", body: { memberId: id } }),
            transformResponse: (res) => res ?? null,
            providesTags: (result, error, id) => [{ type: "MemberFinance", id }],
        }),

        createSalaryPayment: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/createMemberSalaryPayment", method: "POST", body }),
            invalidatesTags: (result, error, body) => [{ type: "MemberFinance", id: body?.memberId }],
        }),

        deleteSalaryPayment: build.mutation({
            query: ({ paymentId, memberId }) => ({ url: "/api/memberRoute/deleteSalaryPayment", method: "DELETE", body: { salaryId: paymentId, memberId } }),
        ...
        getInvestmentsByPartnerId: build.query({
            query: (partnerId) => `/api/memberRoute/getInvestmentsByPartnerId/${partnerId}`,
        ...
        createPartnerInvestment: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/partnerInvestmentCreation", method: "POST", body }),
            invalidatesTags: (result, error, body) => [{ type: "PartnerInvestment", id: body?.partnerId }],
        }),

        updatePartnerInvestment: build.mutation({
            query: ({ id, payload }) => ({ url: `/api/memberRoute/updatePartnerInvestment/${id}`, method: "PUT", body: payload }),
            invalidatesTags: ["PartnerInvestment"],
        }),

        deletePartnerInvestment: build.mutation({
            query: (id) => ({ url: `/api/memberRoute/deletePartnerInvestment/${id}`, method: "DELETE" }),
            invalidatesTags: ["PartnerInvestment"],
        }),
        ...
        getClassPartnershipsByPartnerId: build.query({
            query: (partnerId) => ({ url: `/api/memberRoute/getPartnershipsByPartnerId/${partnerId}` }),
        ...
        createClassPartnership: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/createClassPartnership", method: "POST", body }),
            invalidatesTags: (result, error, body) => [{ type: "ClassPartnership", id: body?.partnerId }],
        }),

        updateClassPartnership: build.mutation({
            query: ({ id, payload }) => ({ url: `/api/memberRoute/updateClassPartnership/${id}`, method: "PUT", body: payload }),
            invalidatesTags: ["ClassPartnership"],
        }),

        deleteClassPartnership: build.mutation({
            query: (id) => ({ url: `/api/memberRoute/deleteClassPartnership/${id}`, method: "DELETE" }),
            invalidatesTags: ["ClassPartnership"],
        }),

        createClassPartnershipPayment: build.mutation({
            query: (body) => ({ url: `/api/memberRoute/${body.classPartnershipId}/payments`, method: "POST", body }),
            invalidatesTags: ["ClassPartnership"],
        }),

        updateClassPartnershipPayment: build.mutation({
            query: (body) => ({ url: `/api/memberRoute/${body.classPartnershipId}/payments/${body.id}`, method: "PUT", body }),
            invalidatesTags: ["ClassPartnership"],
        }),

        deleteClassPartnershipPayment: build.mutation({
            query: (body) => ({ url: `/api/memberRoute/${body.partnershipId}/payments/${body.paymentId}`, method: "DELETE" }),
            invalidatesTags: ["ClassPartnership"],
        }),
        ...
        createSalaryChange: build.mutation({
            query: (body) => ({ url: "/api/memberRoute/salaryCreate", method: "POST", body }),
            invalidatesTags: (result, error, body) => [{ type: "MemberSalaryChange", id: body?.memberId }],
        }),

        updateSalaryChange: build.mutation({
            query: (body) => ({ url: `/api/memberRoute/salaryUpdate/${body.id}`, method: "PUT", body }),
            invalidatesTags: (result, error, body) => [{ type: "MemberSalaryChange", id: body?.memberId }],
        }),

        deleteSalaryChange: build.mutation({
            query: ({ id }) => ({ url: `/api/memberRoute/salaryDelete/${id}`, method: "DELETE" }),
            invalidatesTags: ["MemberSalaryChange"],
        }),

        getSalaryChangeByMemberId: build.query({
            query: (id) => ({ url: `/api/memberRoute/salaryHistoryByMemberId/${id}` }),
