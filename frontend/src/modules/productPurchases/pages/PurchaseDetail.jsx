...
export default function PurchaseDetail() {
    ...
    const { data: paymentsData } = useGetPurchasePayments(id);
                ...
                <div className="flex gap-2 mb-6 border-b border-[var(--border)]">
                    <button
                        ...
                        className={`px-4 py-2 font-medium transition ${
                            activeTab === "details"
                                ? "text-[var(--accent-2)] border-b-2 border-[var(--accent-2)]"
                        ...
                        <div className="card p-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="font-bold text-red-600 text-lg mt-1">Rs {((purchase?.totalAmount ?? 0) - totalPaid).toLocaleString()}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody className="divide-y" style={{ borderColor: "var(--border)" }}>
                                    {purchase?.items?.map((item, index) => (
                                        <tr key={index} className="hover:bg-[var(--surface-muted)] transition-all">
                                            ...
                                            <td className="px-4 py-3 text-right font-medium text-[var(--ink)]">
                                                Rs {(item.price || item.costPrice || item.perItemPrice || 0).toLocaleString()}
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
