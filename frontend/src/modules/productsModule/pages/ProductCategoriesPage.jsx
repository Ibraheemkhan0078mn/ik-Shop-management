...
export default function ProductCategoriesPage() {
                                ...
                                <button
                                    onClick={async () => {
                                        try {
                                            ...
                                            showError(error?.data?.message || error?.message || "Unable to delete category");
                                        }
                                    }}
            ...
            <div className="space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-(--border) bg-(--surface) p-4 shadow-sm">
                    <div>
                        ...
                        <p className="text-sm text-(--muted)">Create and manage product categories in one place.</p>
                    </div>
    ...
    }, [mode, selectedCategoryId, deleteCategory]);
