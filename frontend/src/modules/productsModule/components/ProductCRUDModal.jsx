...
import BrandCRUDModal from "./BrandCRUDModal.jsx";
...
export default function ProductCRUDModal({ mode = "create", productId = null, open, onClose }) {
  ...
  const UNITS = useMemo(() => [
    { value: "volume", label: labels.volume || "Volume" },
    { value: "weight", label: labels.weight || "Weight" },
    { value: "length", label: labels.length || "Length" },
  ], [labels]);
  ...
  return (
    <>
      ...
      {showBrandDialog && <BrandCRUDModal mode="create" open={showBrandDialog} onClose={setShowBrandDialog} onBrandCreated={handleBrandCreated} />}
