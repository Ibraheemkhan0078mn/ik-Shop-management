...
// import { useCreateProduct, useUpdateProduct, useUploadProductImage } from "../services/product.service";
// import { useGetCategoriesQuery } from "../services/category.service.js";
// import { useGetSubCategoriesQuery } from "../services/subCategories.service.js";
// import { useProduct } from "../services/product.service.js";
// import Scanner from "@shared/components/Scanner";
...
//     const [createProduct, { isLoading: isCreating }] = useCreateProduct();
//     const [updateProduct, { isLoading: isUpdating }] = useUpdateProduct();
//     const [uploadProductImage, { isLoading: isUploading }] = useUploadProductImage();

//     // Fetch product data for update mode
//     const { data: productData, isLoading: isFetching } = useProduct(productId, {
...
//                 try {
//                     const result = await uploadProductImage(formDataForUpload).unwrap();
//                     submitData.image = result.filename;
//                 } catch (error) {
...
//             } else {
//                 await updateProduct(submitData).unwrap();
//             }
//             onClose();
//         } catch (error) {
...
//         columns: 2,
//         submitLabel: isCreating || isUpdating || isUploading ? "Saving..." : isCreate ? "Save Product" : "Update Product",
//         fields: [
//             // ─── Most Important ───────────────────────────────────────────
//             { 
//                 name: "image", 
...
//                     catagId={formData.category}
//                     setVisibility={setShowSubCategoryDialog}
//                 />
//             )}
//             <FormLayout
