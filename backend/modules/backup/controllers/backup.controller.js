...
export const exportExcel = async (req, res) => {
    try {
        ...
        const dataSources = [
            ...
            { name: 'PurchaseReturns', service: '../../purchaseReturn/services/purchaseReturn.service.js', method: 'getAllPurchaseReturns' },
...
export const exportFilteredData = async (req, res) => {
    try {
        ...
        const modelServiceMap = {
            ...
            purchaseReturns: { service: '../../purchaseReturn/services/purchaseReturn.service.js', method: 'getAllPurchaseReturns' },
