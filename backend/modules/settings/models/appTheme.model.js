...
const appThemeSchema = new mongoose.Schema(
  {
    ...
    colors: {
      ...
      fontBody: { type: String, default: null },
      fontDisplay: { type: String, default: null },
      radiusCard: { type: String, default: null },
      shadowCard: { type: String, default: null },
      canvasGradient: { type: String, default: null },
      sidebarGradient: { type: String, default: null },
      buttonGradient: { type: String, default: null },
